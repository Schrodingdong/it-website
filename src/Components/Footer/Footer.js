            ...
            <Container sx={footerSX}>
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Box>
                            <a style={{
                                ...
                                <svg width="45" height="36" viewBox="0 0 45 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M42.768 0.8125H1.73446C0.861514 0.8125 0.15625 1.51074 0.15625 2.375V33.625C0.15625 34.4893 0.861514 35.1875 1.73446 35.1875H42.768C43.641 35.1875 44.3462 34.4893 44.3462 33.625V2.375C44.3462 1.51074 43.641 0.8125 42.768 0.8125ZM40.7952 6.22266V31.6719H3.70723V6.22266L2.34602 5.17285L4.28426 2.70703L6.39512 4.33301H38.1123L40.2231 2.70703L42.1614 5.17285L40.7952 6.22266V6.22266ZM38.1123 4.32812L22.2512 16.5352L6.39019 4.32812L4.27933 2.70215L2.34109 5.16797L3.7023 6.21777L20.5497 19.1865C21.0342 19.5592 21.6303 19.7615 22.2438 19.7615C22.8574 19.7615 23.4534 19.5592 23.938 19.1865L40.7952 6.22266L42.1565 5.17285L40.2182 2.70703L38.1123 4.32812Z" fill="#F9F7F7"/>
                                </svg>
                                <Typography variant={"h6"} color={"white"} sx={{fontWeight:300}}>
                                    mailmailmail@gmail.com
                                </Typography>
                            </a>
                        </Box>
                        <Box>
                            <a href={"https://www.instagram.com/ensias_it_club/"} style={{
                                display:"flex",
                                flexDirection:"row",
                                justifyContent:"center",
                                gap:"1rem",
                        ...
                        <Box>
                            <a href={"https://www.facebook.com/ensiasitclub"} style={{
                                display:"flex",
                                flexDirection:"row",
                                justifyContent:"center",
                                gap:"1rem",
